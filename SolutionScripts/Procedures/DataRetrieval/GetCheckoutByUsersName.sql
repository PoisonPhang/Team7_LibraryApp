CREATE OR ALTER PROCEDURE T7Library.GetCheckoutByUsersName
	@NamePartial NVARCHAR(32)
AS
...
WHERE C.ReturnDate IS NULL AND U.FirstName + N' ' + U.LastName LIKE @NamePartial;